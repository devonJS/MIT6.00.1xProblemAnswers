...
def test_calculateHandlen():
    ...
    # test 1
    hand = {'r': 1, 'a': 3, 'p': 2, 'e': 1, 't': 1, 'u':1}
    if calculateHandlen(hand) != 9:
        test_fail = True
        print "FAILURE: test_calculateHandlen()"
        print "\tExpected 9 but got " + str(calculateHandlen(hand))
    ...
    #test 3
    hand = {'e':1, 'v':2, 'n':1, 'i':1, 'l':2}
    if calculateHandlen(hand) != 7:
        test_fail = True
        print "FAILURE: test_calculateHandlen()"
        print "\tExpected 7 but got " + str(calculateHandlen(hand))
